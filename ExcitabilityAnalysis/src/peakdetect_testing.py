...
for i in range(len(trials_pre)):
    ...
    plt.title("EX002 Pre Fwave Identification")
    plt.xlabel("ms")
    plt.ylabel("V")

persistance_pre = (len(amplitude_pre))/60 * 100
print("_______________________________________")
print("EX002 Fwave Persisstance and Amplitude Pre Test")
...
for i in range(len(trials_post)):
    ...
    plt.title("EX002 Post Fwave Identification")
    plt.xlabel("ms")
    plt.ylabel("V")

persistance_post = (len(amplitude_post))/60 * 100
print("_______________________________________")
print("EX002 Fwave Persisstance and Amplitude Post Test")
